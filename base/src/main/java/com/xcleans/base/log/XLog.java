...
/**
 * leak from http://jakewharton.github.io/timber/
...
public class XLog {
    ...
    /**
     * A view into XLog's planted trees as a tree itself. This can be used for injecting a logger
    ...
    public static void plant(Tree tree) {
        ...
        if (tree == TREE_OF_SOULS) {
            throw new IllegalArgumentException("Cannot plant XLog into itself.");
        }
        synchronized (FOREST) {
            FOREST.add(tree);
    ...
    /**
     * A facade for handling logging calls. Install instances via {@link #plant XLog.plant()}.
     */
